 ...
 * environment variable and both call sites fold to `logger: undefined`. Verify
 * that in a built bundle by grepping for the wiring rather than for the
 * symbols: pino ships regardless via `@walletconnect/logger`, and
 * `pinoClientLogger` can survive as an uncalled entry in the SDK's export
 * table.
 *
